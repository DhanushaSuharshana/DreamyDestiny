$(document).ready(function () {
    $('#step-1').click(function () {
        ...
        if (!$('#name').val() || $('#name').val().length === 0) {
            swal({
                title: "Error!",
                text: "Please enter your venue name",
                type: 'error',
                timer: 2000,
            ...
            swal({
                title: "Error!",
                text: "please select your venue type",
                type: 'error',
                timer: 2000,
                showConfirmButton: false
            });
    ...
    $('#step-2').click(function () {
        if (!$('#venue-picture').val() || $('#venue-picture').val().length === 0) {
            swal({
                title: "Error!",
                text: "please upload at least one of your venue image",
                type: 'error',
                timer: 2000,
                showConfirmButton: false
            });
