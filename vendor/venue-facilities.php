                        ...
                        <div class="dashboard-page-head">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"><div class="dropdown">
                                    ...
                                    </div>   Venue Facilities - <?php echo $VENUE->name; ?></div>
                                        ...
                                        <div class="userccount">
                                            <div class="formpanel"> 
                                                <div class="table-responsive">
                                                    <div>
                                                        <form  method="post" action="post-and-get/venue-facilities.php" enctype="multipart/form-data">
                                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $result = VenueFacilityDetails::getFacilitiesByVenueId($id);
                                                                    foreach ($VENUE_GENERAL_FACILITY->all() as $key => $venue_general_facility) {
                                                                        ...
                                                                        <tr id="row_<?php echo $venue_general_facility['id']; ?>">
                                                                            ...
                                                                            <td> 
                                                                                <input  value="<?php echo $venue_general_facility['id']; ?>" <?php
                                                                                $resultFacilities = explode(",", $result['facility']);
                                                                                foreach ($resultFacilities as $items => $resultFacility) {
                                                                                    if ($resultFacility == $venue_general_facility['id']) {
                                                                                        echo 'checked';
                                                                                    }
                                                                                }
                                                            ...
                                                            <div class="text-center">
                                                                <input type="hidden" id="venue_id" value="<?php echo $VENUE->id; ?>" name="venue_id"/>
