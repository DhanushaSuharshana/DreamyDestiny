                                ...
                                <form class="form-horizontal"  method="post" action="post-and-get/visitor.php" enctype="multipart/form-data"> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="first_name" class="form-control" placeholder="Enter Visitor First Name" autocomplete="off" name="first_name" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="last_name" class="form-control" placeholder="Enter Visitor Last Name" autocomplete="off" name="last_name" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group place-select">
                                                <div class="form-line">
                                                    <input type="text" id="password" class="form-control" placeholder="Enter Password" autocomplete="off" name="password" required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
