                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/visitor.php" enctype="multipart/form-data"> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="first_name" class="form-control" placeholder="Enter Visitor name" autocomplete="off" name="first_name" required="TRUE" value="<?php echo $VISITOR->first_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="last_name" class="form-control" placeholder="Enter Last name" autocomplete="off" name="last_name" required="TRUE" value="<?php echo $VISITOR->last_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="address" class="form-control" placeholder="Enter address" autocomplete="off" name="address" required="TRUE" value="<?php echo $VISITOR->address; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                            ...
                                            <div class="form-group place-select">
                                                <div class="form-line">
                                                    <select class="form-control show-tick place-select1" type="text" id="city" autocomplete="off" name="city">
                                                        <option value="<?php echo $VISITOR->id; ?>" class="active light-c">
                                                            <?php
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    if (empty($VISITOR->image_name)) {
                                                        ?>
                                                        <img src="../upload/visitor/visitor.png" id="image" class="view-edit-img img img-responsive img-thumbnail" name="image" alt="old image"/>
                                                        <?php
                                                    } else {
                                                        if ($VISITOR->googleID && substr($VISITOR->image_name, 0, 5) === "https") {
                                                            ?>
