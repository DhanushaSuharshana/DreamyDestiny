...
$VENUE_FACILITY_DETAILS = new VenueGeneralFacilities(NULL);
?> 
﻿<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <title>View Venue Facilities</title>
        <!-- Favicon-->
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Facilities of <?php echo $VENUE->name; ?> 
                                </h2>
                            ...
                            <div class="body">
                                ...
                                <div>
                                    <form  method="post" action="post-and-get/venue-facilities-details.php" enctype="multipart/form-data">
                                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $result = VenueFacilityDetails::getFacilitiesByAccommodationId($id);
                                                foreach ($VENUE_GENERAL_FACILITY->all() as $key => $accommodation_general_facility) {
                                                    ?>
