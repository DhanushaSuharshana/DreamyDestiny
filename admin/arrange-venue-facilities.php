...
<html> 
    <head>
        ...
        <title>Arrange Venue Facilities</title>
        <!-- Favicon-->
            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Venue Facilities</h2>
                            ...
                            <form method="post" action="post-and-get/venue-general-facility.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($VENUE_GENERAL_FACILITY->all()) > 0) {
                                                        foreach ($VENUE_GENERAL_FACILITY->all() as $key => $img) {
                                                            ?>
