...
if (isset($_POST['create'])) {
    ...
    $dir_dest = '../../upload/venue-facilities-icons/';
...
if (isset($_POST['update'])) {
    ...
    $ACCOMODATION_GENERAL_FACILITY = new VenueGeneralFacilities($_POST['id']);
...
if (isset($_POST['save-data'])) {
    ...
    foreach ($_POST['sort'] as $key => $img) {
        ...
        $ACCOMODATION_GENERAL_FACILITY = VenueGeneralFacilities::arrange($key, $img);
