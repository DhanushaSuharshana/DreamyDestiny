...
$VENUE_OBJ = new Venue(NULL);
$VENUE_PHOTO_OBJ = new VenuePhoto(NULL);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <?php
                            $VENUES = $VENUE_OBJ->getVenueByType($type);
                            foreach ($VENUES as $venue) {
                                $VENUE_PHOTOS = $VENUE_PHOTO_OBJ->getVenuePhotosById($venue['id']);
                                ...
                                <div class="col-md-4 vendor-box">
                                    ...
                                    <div class="vendor-image">
                                        ...
                                        foreach ($VENUE_PHOTOS as $key => $venue_photo) {
                                            if ($key == 0) {
                                                ?>
                                                <!-- venue pic -->
                                                <a href="#"><img src="upload/venue/<?php echo $venue_photo['image_name'] ?>" alt="wedding venue" class="img-responsive"></a>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <div class="vendor-detail">
                                        ...
                                        <a href="#">
                                            <div class="caption">
                                                <!-- caption -->
                                                <h2><div class="title"><?php echo $venue['name'] ?></div></h2>
                                                <p class="location"><?php echo $VENUE_TYPE->name ?></p>
                                             
                                                <div class="rating "><i class="fa fa-map-marker"></i> <?php echo $CITY->name ?> </div>
                                          
                                            </div>
                                            <!-- /.caption -->
                                            <div class="vendor-price text-center">
