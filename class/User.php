...
class User
{
    ...
    public function create($name, $type,$active, $email, $username, $password)
    {
        $enPass = md5($password);

        date_default_timezone_set('Asia/Colombo');
        $createdAt = date('Y-m-d H:i:s');
        $query = "INSERT INTO `user` (`name`,`type`,`isActive`, `email`, `createdAt`,  `username`, `password`) VALUES  ('" . $name . "', '" . $type . "','" . $active . "', '" . $email . "', '" . $createdAt . "', '" . $username . "', '" . $enPass . "')";
